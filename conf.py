...
#
# source_suffix = ['introduction.rst', '.md']
source_suffix = '.rst'
...
copyright = u'2021, Pyramid Technologies Inc'
author = u'Pyramid Technologies'
...
exclude_patterns = ['build', 'Thumbs.db', '.DS_Store', 'global.rst']
