...
.. py:attribute:: QR Generator - $1C $7D $25
    ...
    Encodes the specified string as a QR code using the specified width. The resulting QR code will be center justified unless you override the line justification beforeissue the command.
