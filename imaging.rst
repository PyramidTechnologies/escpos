...
-------------------------------------------------------
       ...
       - Form 1: 0 ≤ `m` ≤ 20
        ...
        +-------+----------------+-------------------+----------------------------+------------------+
        | m     | Barcode System | No. of Characters | Valid Characters (decimal) | Min Firm. Version|
        +=======+================+===================+============================+==================+
...
--------------------------------------------
    ...
    :Example:
        .. code-block:: none
            ...
            write('\x1b\xfa\x01\x00\x0a\x00\xc8') # Print logo 1 from dotlines 10 to 200

    :Example:
        .. code-block:: none

            write('\x1b\xfa\x02\x00\x00\x03\x5e') # Print logo 2 from dotlines 0 to 861
...
--------------------------------------------------------
    ...
    :Example:
        .. code-block:: none
            ...
            write('\x1c\x79\x02\x00') # Print the second logo
